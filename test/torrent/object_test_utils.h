...
torrent::Object create_bencode_raw_bencode_c(const char* str);
torrent::Object create_bencode_raw_string_c(const char* str);
torrent::Object create_bencode_raw_list_c(const char* str);
torrent::Object create_bencode_raw_map_c(const char* str);
